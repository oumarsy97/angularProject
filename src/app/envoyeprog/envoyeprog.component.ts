...
import {SendtoprogComponent} from '../sendtoprog/sendtoprog.component'; // Import Contact interface

@Component({
  selector: 'app-envoyeprog',
  templateUrl: 'envoyeprog.component.html',
  standalone: true,
  imports: [NgIf, NgForOf, SendtoComponent, TransactionDetailComponent, TransactionFilterComponent, FormsModule, SendtoComponent, SendtoprogComponent],
  animations: [
...
export class EnvoyeprogComponent implements OnInit {
